...
;(find-file "/sftp:albinus@albinus.homelinux.org:")

;(find-file "/sftp:root@gauss.cmc3.tmntest.sel.alcatel.de:")
;(find-file "/sftp:albinus@slbhah.tmntest.sel.alcatel.de:")

;(file-attributes "/smb:nb_owner%WL022989@192.168.136.1:/C$/autoexec.bat")
;(find-file "/smb:nb_owner%WL022989@192.168.136.1:/C$")
;(find-file "/smb:nb_owner%WL022989@192.168.136.1:/Programme")

;(find-file "/smb:nb_owner%WL022989@192.168.0.6:/C$")
;(find-file "/smb:nb_owner%WL022989@192.168.0.6:/Programme")

;(find-file "/smb:Sigrid%ERNA@192.168.0.2:/C")

;(find-file "/smb:local_adm%BT0074D@bt0074d.de.alcatel-lucent.com:/C$")

;(find-file "/sftp:albinus@localhost:/home/albinus")
;(find-file "/sftp::/home/albinus")
;(find-file "/sftp::")

;(find-file "/dav:michael.albinus@gmx.de@mediacenter.gmx.net:")
;(find-file "/davs:michael.albinus@gmx.de@mediacenter.gmx.net:")

;(find-file "/obex:WL022989:")
;(find-file "/obex:[00:21:86:47:09:4A]:")

;(find-file "/obex:Michael Albinus:")

;(setq message-log-max t)

;(setq tramp-gvfs-methods '("dav" "davs" "ftp" "obex" "sftp" "smb"))
